...
| Hash | Message |
|------|---------|
| `36b3b66` | feat: add contractor profile modal, footer, fix nav labels, empty state, rename to Houseconnect Pro |
| `6d47c2b` | feat: redesign footer with logo, socials, services, company, contact columns, dashed bar |
| `ac09c16` | added dummy workers in find pros section to show when database is empty |
| `1ec2f38` | added company policy pages (about us, careers, privacy, terms) linked from footer |
| `8c95a40` | perf: removed blocking supabase calls from stats, navbar and contractors page to fix slow rendering |
| `44ef849` | fix: X icon in footer, social links open external tabs, entrance animations on hero and stats |
...
*Log maintained by developer. All timestamps reflect active development during this session.*
