      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl border-4 border-black shadow-[8px_8px_0px_0px_#000]">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleAuth}>
          <div className="space-y-4">
            <div>
              <label className="block text-black font-black mb-1 uppercase text-sm">
                Email Address
              </label>
              <input
                type="email"
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex justify-center py-3 px-4 border-3 border-black text-lg font-black rounded-lg text-black bg-yellow-300 hover:bg-yellow-400 hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#000] shadow-[4px_4px_0px_0px_#000] transition-all focus:outline-none uppercase tracking-wide"
            >
              <i className="fas fa-user-secret mr-2 mt-1"></i> Continue as Guest
            </button>
          </div>
        </form>
