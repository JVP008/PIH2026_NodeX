    ...
    <div className="min-h-screen bg-green-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-xl border-4 border-black shadow-[8px_8px_0px_0px_#000]">
        ...
        <div className="space-y-6 text-xl font-medium text-black leading-relaxed">
          <p>
            We are a small team with a massive goal to organize the home services market across
            India. Up until now, finding reliable help has been totally broken. We are fixing that,
            block by block.
          </p>
          <p>
            Right now, we are looking for passionate builders. You do not need a fancy degree to
            join us. You just need to care deeply about the user experience and be willing to solve
            tough problems.
          </p>
