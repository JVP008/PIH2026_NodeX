...
export default async function ContractorDetailPage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <Link
        href="/contractors"
        className="text-black font-bold hover:underline decoration-2 decoration-black underline-offset-2 mb-6 inline-block"
      >
      ...
      <div className="bg-white border-4 border-black rounded-xl shadow-[8px_8px_0px_0px_#000] overflow-hidden">
        ...
        <div className="px-8 pb-8">
          <div className="relative -mt-16 mb-6 flex items-end justify-between">
            ...
            <div className="mb-2">
              <span
                className={`px-4 py-2 rounded font-black border-2 border-black shadow-[2px_2px_0px_0px_#000] text-sm ${contractor.available ? 'bg-green-200 text-black' : 'bg-gray-200 text-gray-600'}`}
              >
              ...
              <div>
                ...
                <p className="text-black font-medium leading-relaxed text-lg">
                  {contractor.description ||
                    `Experienced ${contractor.service} professional serving the ${contractor.location} area. Committed to high-quality work and customer satisfaction.`}
                </p>
              </div>
