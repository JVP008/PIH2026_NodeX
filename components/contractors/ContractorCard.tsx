        ...
        <div className="flex-1 min-w-0 flex flex-col h-full">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="text-right shrink-0">
              <div className="flex items-center text-yellow-500 justify-end drop-shadow-[1px_1px_0px_#000]">
                ...
                <span className="text-gray-600 text-sm ml-1 font-bold">
                  ({contractor.reviews})
                </span>
              </div>
              <p className="text-sm text-black font-bold whitespace-nowrap">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mt-auto pt-6">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span
                className={`flex items-center font-bold border-2 border-black px-2 py-1 rounded shadow-[2px_2px_0px_0px_#000] whitespace-nowrap ${contractor.available ? "bg-green-200 text-black" : "bg-gray-200 text-gray-600"}`}
              >
                <span
