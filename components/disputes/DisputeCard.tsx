 ...
 *
 * Displays the details of a dispute (a complaint) that a user has submitted regarding a booking.
 * Shows the status (e.g., pending, resolved) and what type of issue it is.
 */
    ...
    <div className="bg-white border-3 border-black rounded-xl shadow-[6px_6px_0px_0px_#000] p-4 flex items-center justify-between mb-4">
      <div>
        ...
        <p className="text-sm text-black font-medium">
          Submitted:{' '}
          {dispute.created_at ? new Date(dispute.created_at).toLocaleDateString() : 'Unknown Date'}
        </p>
