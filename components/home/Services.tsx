 ...
 * Services Component
 *
 * Displays a colorful grid of the main service categories we offer (Plumbing, Electrical, etc.).
 * Clicking on a category takes the user directly to a list of professionals in that category.
 */
