      ...
      <div className="relative max-w-7xl mx-auto z-10">
        <div className="text-center mb-12">
          ...
          <p className="font-bold text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            The home services sector is massive, chaotic, and completely unorganized. We&apos;re
            bringing transparency, speed, and trust — one verified booking at a time.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-4">
          {stats.map((s, i) => (
            ...
            >
              <div
                className={`absolute -top-6 -right-6 w-16 h-16 ${s.color} border-4 border-black rounded-full flex items-center justify-center text-3xl shadow-[4px_4px_0px_0px_#000] rotate-12 group-hover:rotate-0 transition-transform duration-300 z-10`}
              >
                {s.icon}
              </div>
              <div className="pt-4">
