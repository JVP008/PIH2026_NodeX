...
const testimonials = [
  {
    ...
    service: 'Plumbing',
    review:
      'Got a plumber in under 2 hours for a burst pipe emergency. The contractor was verified and fixed it perfectly. HouseConnect saved my day!',
    rating: 5,
    avatar: '👩',
  },
  {
    ...
    service: 'Electrical',
    review:
      'Found a certified electrician for my new flat wiring. Price was transparent from the start — no hidden charges. Will use again.',
    rating: 5,
    avatar: '👨',
  },
  {
    ...
    service: 'Cleaning',
    review:
      'The deep cleaning team for my 3BHK was exceptional. They used eco-friendly products and were done in 4 hours. ₹2200 well spent.',
    rating: 4,
    avatar: '👩‍💼',
  },
  {
    ...
    service: 'HVAC',
    review:
      'AC was making noise for months. Booked the HVAC guy on Sunday evening, he came Monday morning. Fixed the compressor issue. 10/10!',
    rating: 5,
    avatar: '🧑',
  },
];
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="flex gap-0.5 mb-3">
                {[...Array(5)].map((_, j) => (
                  <span key={j} className={j < t.rating ? 'text-yellow-400' : 'text-gray-300'}>
                    ★
                  </span>
                ))}
              </div>
