 ...
 * Hero Component
 *
 * The "Hero" is the big, eye-catching top section of the homepage.
 * It explains the main goal of HouseConnect in one sentence and provides
 * two large buttons for users to either "Post a Job" or "Browse Pros".
 */
const Hero = memo(() => {
  return (
    <section className="relative py-20 px-4 bg-[#fdfbf8] overflow-hidden border-b-8 border-yellow-300">
      ...
      <div className="relative max-w-7xl mx-auto px-4 text-center z-10">
        ...
        <p className="text-2xl text-black font-medium mb-8 max-w-2xl mx-auto leading-relaxed">
          Tell us what needs fixing at home and we connect you with trusted, verified local
