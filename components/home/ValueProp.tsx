            ...
            <div className="max-w-6xl mx-auto px-4 relative z-10 flex flex-col items-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 w-full mb-16">
                    ...
                    <div className="bg-white border-[3px] border-black rounded-lg p-6 neo-shadow hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[8px_8px_0px_#000] transition-all relative">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-black mb-2 tracking-tight">₹1.2L Cr</div>
                        <div className="text-[10px] md:text-xs font-black uppercase text-gray-600 tracking-wider">Market Size</div>
                    </div>
                    ...
                    <div className="bg-white border-[3px] border-black rounded-lg p-6 neo-shadow hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[8px_8px_0px_#000] transition-all relative">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-black mb-2 tracking-tight">90%</div>
                        <div className="text-[10px] md:text-xs font-black uppercase text-gray-600 tracking-wider">Unorganized Sector</div>
                    </div>
                    ...
                    <div className="bg-white border-[3px] border-black rounded-lg p-6 neo-shadow hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[8px_8px_0px_#000] transition-all relative">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-black mb-2 tracking-tight">50+</div>
                        <div className="text-[10px] md:text-xs font-black uppercase text-gray-600 tracking-wider">Cities Targeted</div>
                    </div>
                    ...
                    <div className="bg-white border-[3px] border-black rounded-lg p-6 neo-shadow hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[8px_8px_0px_#000] transition-all relative">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-black mb-2 tracking-tight">&lt; 2 Hrs</div>
                        <div className="text-[10px] md:text-xs font-black uppercase text-gray-600 tracking-wider">Average SLA</div>
                    </div>
                </div>
