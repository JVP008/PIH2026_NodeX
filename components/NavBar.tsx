        ...
        <nav className="bg-white border-b-4 border-black sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    <Link href="/" aria-label="HouseConnect Home" className="flex items-center space-x-2 cursor-pointer group">
                        ...
                        <span className="text-2xl font-bold tracking-tight text-black group-hover:underline decoration-2 decoration-wavy decoration-blue-400">HouseConnect Pro</span>
                    </Link>
