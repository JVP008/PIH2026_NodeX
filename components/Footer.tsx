        ...
        <footer className="bg-white text-black border-t-4 border-black pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid md:grid-cols-4 gap-8 mb-12">
                    <div>
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <span className="text-2xl font-black tracking-tight uppercase">HouseConnect</span>
                        </div>
                        <p className="text-black font-medium mb-4">
                            India&apos;s trusted platform connecting homeowners with verified local professionals across 50+ cities.
                        </p>
                        <div className="flex gap-4">
                            <a href="https://x.com/jayeshpatila15" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border-3 border-black rounded-full flex items-center justify-center hover:bg-gray-100 hover:translate-y-[-2px] hover:shadow-[4px_4px_0px_0px_#000] shadow-[2px_2px_0px_0px_#000] transition-all" aria-label="X (Twitter)">
                                <i className="fa-brands fa-x-twitter text-black"></i>
                            </a>
                            <a href="https://www.instagram.com/jayesh_patil_008?igsh=ZWY0bXpnM29lcDZt" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border-3 border-black rounded-full flex items-center justify-center hover:bg-blue-600 hover:translate-y-[-2px] hover:shadow-[4px_4px_0px_0px_#000] shadow-[2px_2px_0px_0px_#000] transition-all" aria-label="Facebook">
                                <i className="fa-brands fa-facebook-f text-black"></i>
                            </a>
                            <a href="https://www.instagram.com/jayesh_patil_008?igsh=ZWY0bXpnM29lcDZt" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border-3 border-black rounded-full flex items-center justify-center hover:bg-pink-400 hover:translate-y-[-2px] hover:shadow-[4px_4px_0px_0px_#000] shadow-[2px_2px_0px_0px_#000] transition-all" aria-label="Instagram">
                                <i className="fa-brands fa-instagram text-black"></i>
                            </a>
                            <a href="https://www.linkedin.com/in/jayesh-vinod-patil" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border-3 border-black rounded-full flex items-center justify-center hover:bg-blue-700 hover:translate-y-[-2px] hover:shadow-[4px_4px_0px_0px_#000] shadow-[2px_2px_0px_0px_#000] transition-all" aria-label="LinkedIn">
                ...
                <div className="border-t-2 border-black border-dashed pt-8 text-center text-black font-bold">
                    <p>&copy; {new Date().getFullYear()} HouseConnect Pro. All rights reserved. Made with ❤️ in India</p>
                </div>
            </div>
        </footer>
    );
