    ...
    <footer className="bg-white text-black border-t-4 border-black pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-black font-medium mb-4">
              India&apos;s trusted platform connecting homeowners with verified local professionals
              across 50+ cities.
            </p>
        ...
        <div className="border-t-2 border-black border-dashed pt-8 text-center text-black font-bold">
          <p>
            &copy; {new Date().getFullYear()} HouseConnect Pro. All rights reserved. Made with ❤️ in
            India
          </p>
        </div>
      </div>
